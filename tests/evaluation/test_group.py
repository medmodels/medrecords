...
class RaisingNodes(Derivation[MedRecord, Mapping[str, MedRecord]]):
...
class TestGroup(unittest.TestCase):
    ...
    def test_add_analytic(self) -> None:
        ...
        assert create_report(added).analytic("count").value(int) == 2
    ...
    def test_add_group(self) -> None:
        ...
        assert nested.analytic("count").value(int) == 2
    ...
    def test_add_group_over_each(self) -> None:
        ...
        assert keyed.group("lorem").analytic("count").value(int) == 1
